...
class RedirectToLocaleSubscriber implements EventSubscriberInterface
{
    ...
    public function __construct(private readonly AbstractAppRouteHelper $appRouteHelper, private readonly UrlGeneratorInterface $urlGenerator, string $locales, ?string $defaultLocale = null)
    {
    ...
    public function onKernelRequest(RequestEvent $event): void
    {
        ...
        $response = new RedirectResponse($this->urlGenerator->generate($this->appRouteHelper->getRouteForDemo('homepage'), ['_locale' => $preferredLanguage]));
